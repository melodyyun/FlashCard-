...
class CardsList extends React.Component {
  ...
  componentWillMount() {
    const dbRefCardsList = firebase
      .database()
      .ref(`user/decksList/${this.props.selectedDeckId}/cardsList/`);
  ...
  deleteCard(cardKey) {
    firebase
      .database()
      .ref(`user/decksList/${this.props.selectedDeckId}/cardsList/${cardKey}`)
      .remove();
  }
  ...
  createCard(e, key) {
    ...
    const dbRefDeck = firebase
      .database()
      .ref(`user/decksList/${key}/cardsList`);
    dbRefDeck.push(card);
    ...
    return (
      <div>
        ...
        <CardForm className="createDeckFormParent wrapper">
          <form
            className="createDeckForm formBg marginTop2"
            action=""
            onSubmit={e => this.createCard(e, this.props.selectedDeckId)}
          >
            <h3>Create a Card!</h3>
            <input
              type="text"
