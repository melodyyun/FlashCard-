        ...
        return(
            <EditCardsContainer className="wrapper">
                ...
                <div className="btn-container wrapper clearfix">
                    <button className="btn float-right" name="home" value={this.props.selectedDeckId} onClick={(e) => this.props.changeDisplay(e)}>Home</button>
                    <button className="btn float-right" name="study" value={this.props.selectedDeckId} onClick={(e) => this.props.changeDisplay(e)}>Study</button>
                </div>
                <CardsList 
